                        ...
                        <tr>
                            <td width="100%">
                               <table bgcolor="#fff" border="0" cellspacing="0" cellpadding="25" width="100%" style="text-align:left">
                                    <tr>
                                        <td class="forgot-pwd" colspan="2" style="padding:15px 0px; font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#333;"><strong>Tradence Account Verification</strong></td>
                                      </tr>
                                    <tr style="background-color:#fff;">
                                        <td colspan="2" style="padding:15px 0 0px 0; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#666;  border-top: 1px solid #e2e2e2;">Hi,</td>
                                    </tr>
                                    <tr style="background-color:#fff;">
                                        <td colspan="2" style="padding:10px 0 10px 0; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#666;">Thanks for  joining Tradence !! </td>
                                    </tr>
                                    <tr style="background-color:#fff; border: 1px solid #e2e2e2;">
                                        <td colspan="2" style="padding:0px; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#666; line-height:25px; line-height: 20px;">
                                            To provide you the best service possible, we require you to verify your email address. Please verify your email id by clicking on below button. 
                                        </td>
                                    </tr>
                                    <tr>
